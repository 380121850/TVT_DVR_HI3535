...
typedef struct hiPCIV_SRCPIC_S
{
...
typedef struct hiPCIV_RECVPIC_S
{
...
typedef HI_S32 FN_PCIV_SrcSendPic(PCIV_CHN pcivChn, PCIV_SRCPIC_S *pSrcPic, VI_MIXCAP_STAT_S *pstMixCapState);
typedef HI_S32 FN_PCIV_RecvPicFree(PCIV_CHN pcivChn, PCIV_RECVPIC_S *pRecvPic);

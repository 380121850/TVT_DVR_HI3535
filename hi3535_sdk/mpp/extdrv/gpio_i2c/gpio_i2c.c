...
#define GPIO_0_BASE 0x201A0000	/* actually, it's GPIO_5_BASE at Hi3535 ASIC */
#define SCL_SHIFT_NUM   7
#define SDA_SHIFT_NUM   6
#define SCL                 (0x1 << SCL_SHIFT_NUM)    /* GPIO5 0_7 */
#define SDA                 (0x1 << SDA_SHIFT_NUM)    /* GPIO5 0_6 */
#define GPIO_I2C_SCL_REG    IO_ADDRESS(GPIO_0_BASE + (0x1<<(SCL_SHIFT_NUM+2)))  /* 0x200 */
#define GPIO_I2C_SDA_REG    IO_ADDRESS(GPIO_0_BASE + (0x1<<(SDA_SHIFT_NUM+2)))  /* 0x100 */
#define GPIO_I2C_SCLSDA_REG IO_ADDRESS(GPIO_0_BASE +((0x1<<(SCL_SHIFT_NUM+2))+(0x1<<(SDA_SHIFT_NUM+2))))  /* 0x300 need check */

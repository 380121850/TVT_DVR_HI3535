...
HI_S32 HI_MPI_VO_GetScreenFrame    (VO_LAYER VoLayer, VIDEO_FRAME_INFO_S *pstVFrame);
...
HI_S32 HI_MPI_VO_SetChnField(VO_LAYER VoLayer, VO_CHN VoChn, const VIDEO_FIELD_E enField);
HI_S32 HI_MPI_VO_GetChnField(VO_LAYER VoLayer, VO_CHN VoChn, VIDEO_FIELD_E *pField);
...
HI_S32 HI_MPI_VO_GetChnFrame(VO_LAYER VoLayer, VO_CHN VoChn, VIDEO_FRAME_INFO_S *pstFrame);
...
HI_S32 HI_MPI_VO_GetWbcFrame(VO_WBC VoWbc, VIDEO_FRAME_INFO_S *pstVFrame);
...
HI_S32 HI_MPI_VO_BindCascadePos(HI_U32 u32Pos, VO_DEV VoCasDev, VO_CHN VoChn);
HI_S32 HI_MPI_VO_UnBindCascadePos(HI_U32 u32Pos, VO_DEV VoCasDev, VO_CHN VoChn);
...
HI_S32 HI_MPI_VO_SetVgaSharpenParam(VO_DEV VoDev, HI_S32 s32Strength);
HI_S32 HI_MPI_VO_GetVgaSharpenParam(VO_DEV VoDev, HI_S32* ps32Strength);

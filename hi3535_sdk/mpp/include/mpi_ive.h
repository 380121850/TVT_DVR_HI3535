...
*   Description: Describes the information about color space conversion (CSC). Only the conversion from YUV to 
			  RGB is supported. The SP420 and SP422 input format is supported.
*   Input        : IVE_HANDLE *pIveHandle  Returned handle ID of a task         
*                  IVE_SRC_INFO_S *pstSrc  Input source data    
*                  IVE_MEM_INFO_S *pstDst  Output result    
...
*   Description: Describes the information about SOBEL. HI_MPI_IVE_SOBEL is used to extract the edge information. 
			  Only the single-component input format is supported.
*   Input        : IVE_HANDLE *pIveHandle  Returned handle ID of a task          
*                  IVE_SRC_INFO_S *pstSrc  Input source data        
...
HI_S32 HI_MPI_IVE_SOBEL(IVE_HANDLE *pIveHandle, IVE_SRC_INFO_S *pstSrc, 
        IVE_MEM_INFO_S *pstDstH, IVE_MEM_INFO_S *pstDstV, IVE_SOBEL_CTRL_S *pstSobelCtrl,HI_BOOL bInstant);


/*****************************************************************************
*   Prototype    : HI_MPI_IVE_CANNY
*   Description: Describes the information about CANNY. HI_MPI_IVE_CANNY is used to extract the edge information and is more complicated
			   than HI_MPI_IVE_SOBEL. HI_MPI_IVE_CANNY does not provide comprehensive functions. Only the single-component input format is supported.
*   Input        : IVE_HANDLE *pIveHandle  Returned handle ID of a task             
*                  IVE_SRC_INFO_S *pstSrc  Input source data             
...
HI_S32 HI_MPI_IVE_CANNY(IVE_HANDLE *pIveHandle, IVE_SRC_INFO_S *pstSrc, 
        IVE_MEM_INFO_S *pstDstMag, IVE_MEM_INFO_S *pstDstAng, IVE_CANNY_CTRL_S *pstCannyCtrl,HI_BOOL bInstant);


/*****************************************************************************
*   Prototype    : HI_MPI_IVE_DILATE
*   Description: Describes the information about dilate. This API can be used to implement bold characters and fault offset. 
			  Only the single-component input format is supported.
*   Input        : IVE_HANDLE *pIveHandle  Returned handle ID of a task           
*                  IVE_SRC_INFO_S *pstSrc  Input source data             
*                  IVE_MEM_INFO_S *pstDst  Output result           
...
*   Description: Describes the information about AND. The pixel points at mapping positions of two input sources are ANDed.
			   Only the single-component input format is supported.
*   Input        : IVE_HANDLE *pIveHandle  Returned handle ID of a task
...
*   Description: Describes the information about SUB. The pixel points of an input source are subtracted from the pixel points
			  at the mapping positions of another input source. Only the single-component input format is supported.
*   Input        : IVE_HANDLE *pIveHandle  Returned handle ID of a task
...
HI_S32 HI_MPI_IVE_SUB(IVE_HANDLE *pIveHandle, IVE_SRC_INFO_S *pstSrc1, 
    IVE_SRC_INFO_S *pstSrc2,IVE_MEM_INFO_S *pstDst, IVE_SUB_OUT_FMT_E enOutFmt,HI_BOOL bInstant);


/*****************************************************************************
*   Prototype    : HI_MPI_IVE_OR
*   Description: Describes the information about OR. The pixel points at mapping positions of two input sources are ORed. 
			  Only the single-component input format is supported.
*   Input        : IVE_HANDLE *pIveHandle  Returned handle ID of a task
...
*   Description: Describes the information about integral statistics. This API is used to collect statistics on the single-component data
			  in the form of integrogram. Only the single-component input format is supported.
*   Input        : IVE_HANDLE *pIveHandle  Returned handle ID of a task
*                  IVE_SRC_INFO_S *pstSrc  Input source data
*                  IVE_MEM_INFO_S *pstDst  Output result
*                  HI_BOOL bInstant        For details, see HI_MPI_IVE_DMA.
...
*   Description: Describes the information about histogram statistics. This API is used to collect statistics on the single-component data
			  in the form of histogram. Only the single-component input format is supported.
*   Input        : IVE_HANDLE *pIveHandle  Returned handle ID of a task
*                  IVE_SRC_INFO_S *pstSrc  Input source data
*                  IVE_MEM_INFO_S *pstDst  Output result
*                  HI_BOOL bInstant        For details, see HI_MPI_IVE_DMA.

...
typedef struct hiVENC_PARAM_H264_REF_S
{
...
typedef enum hiVENC_H264_REF_MODE_E
{
    H264E_REF_MODE_1X = 1,                         /*Normal reference mode.*/
    H264E_REF_MODE_2X = 2,                         /*Two frames are separated by two skipping frames.*/
    H264E_REF_MODE_4X = 5,                         /*Two frames are separated by four skipping frames.*/
    H264E_REF_MODE_BUTT,
...
typedef struct hiVENC_PARAM_H264_INTRA_PRED_EX_S
{
    HI_BOOL bIntra16DCEn;
    HI_BOOL bIntra4Mod3En;
    HI_BOOL bIntra8Mod3En;
    HI_BOOL bIntra16Mod3En;
}VENC_PARAM_H264_INTRA_PRED_EX_S;

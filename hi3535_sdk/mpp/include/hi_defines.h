...
#define VDH_VEDU_CHN		    64				/*VDH 与VEDU临界通道*/
#define VEDU_MAX_CHN_NUM	    80 // (VDEC_MAX_CHN_NUM-VDH_VEDU_CHN)
...
/* for VDH-MPEG4 */
#define VDH_OTHER_MAX_WIDTH       1920
#define VDH_OTHER_MAX_HEIGHT      1088

...
/******************************************************************************
* Function:      JPG_SetOutYCbCr420
* Description:   set decode output yuv420
* Input:         Handle
* Input:         bOutYCbCr420  if output yuv420
* Output:        
* Return:        no
* Others:        no
******************************************************************************/
HI_S32 JPG_SetOutYCbCr420(JPG_HANDLE Handle,HI_BOOL bOutYCbCr420);


/******************************************************************************
* Function:      JPG_GetOutYCbCr420
* Description:   
* Input:         Handle
* Input:         *bOutYCbCr420
* Output:        
...
* Others:        no
******************************************************************************/
HI_S32 JPG_GetOutYCbCr420(JPG_HANDLE Handle,HI_BOOL *bOutYCbCr420);



/******************************************************************************
* Function:      JPG_SetLuaPixSumFlag
* Description:   set if should output lu pix sum
* Input:         Handle
* Input:         bLuPixSum
* Output:        
* Return:        no
* Others:        no
******************************************************************************/
HI_S32 JPG_SetLuPixSumFlag(JPG_HANDLE Handle,HI_BOOL bLuPixSum);


/******************************************************************************
* Function:      JPG_GetLuPixSumFlag
* Description:   
* Input:         Handle
* Input:         *bLuPixSum
* Output:        
...
* Others:        no
******************************************************************************/
HI_S32 JPG_GetLuPixSumFlag(JPG_HANDLE Handle,HI_BOOL *bLuPixSum);


/******************************************************************************
* Function:      JPG_GetLuPixSum
* Description:   
* Input:         Handle
* Input:         *u64LuPixSum
* Output:        
...
* Others:        no
******************************************************************************/
HI_S32 JPG_GetLuPixSum(JPG_HANDLE Handle,HI_U64 *u64LuPixSum);
...
#ifdef CONFIG_JPGD_SETMEM
/******************************************************************************
* Function:      JPG_SetBuf_PhyAddr
* Description:   get phy address by bvt sdk realize,
                 realize at code/mpi/jpegd/jpegd_usr.c
* Input:         Size
* Input:         align
* Output:        ppVirtAddr
* Return:        HI_SUCCESS 
...
* Others:        
******************************************************************************/
HI_U32  JPG_SetBuf_PhyAddr(HI_U32 Size, HI_U32 align, HI_VOID** ppVirtAddr);
#endif

...
HI_S32 vo_vga_config(HI_U32 u32Dev,HI_U32 enCscMode,HI_U32 u32Luma, HI_U32 u32Contrast, HI_U32 u32Hue, HI_U32 u32Satuature, HI_U32 u32Gain, HI_U32 u32Strength)
{
    ...
    stVgaParam.stCSC.u32Satuature = u32Satuature;
    ...
    printf("matrix %d, con %d, hue %d, luma %d, stu %d\n", stVgaParam.stCSC.enCscMatrix,
        stVgaParam.stCSC.u32Contrast, stVgaParam.stCSC.u32Hue, stVgaParam.stCSC.u32Luma, stVgaParam.stCSC.u32Satuature);
    
    VO_CHECK_RET(HI_MPI_VO_SetVgaSharpenParam(u32Dev, u32Strength), "HI_MPI_VO_SetVgaSharpenParam"); 
    VO_CHECK_RET(HI_MPI_VO_GetVgaSharpenParam(u32Dev, &u32Strength), "HI_MPI_VO_GetVgaSharpenParam");
    printf("u32Strength is setted to  %d \n",u32Strength);
    return HI_SUCCESS;
}
...
HI_S32 main(int argc, char *argv[])
{
    ...
    vo_vga_config(u32Dev,u32Matrix,u32Luma, u32Contrast, u32Hue, u32Satuature,u32Gain, u32Strength);

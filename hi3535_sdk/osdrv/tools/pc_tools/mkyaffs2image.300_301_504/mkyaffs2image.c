...
const char yaffs2_version[] = "Linux-2.6.35";
...
static int write_tag_file(unsigned int nandip, int pagetype, int ecctype)
{
	...
	*len = sprintf(ptr, "\nyaffs2 file system: %s %s \n"
	...
	write_chunk((unsigned char*)buffer, tagObjId, 1024, status.st_size);
...
{
	printf("Usage:\n");
	printf("    %s {dir} {image} {pagesize} {ecctype} [-b blocksize] [-v].\n",
		shoftname);
	printf("    dir          the directory tree to be converted\n");
	printf("    image        the output file to hold the image\n");
	printf("    pagesize     the page size to be converted\n");
	printf("                 0 | 512     512 Bytes pagesize\n");
	printf("                 1 | 2k      2K Bytes pagesize\n");
	printf("                 2 | 4K      4K Bytes pagesize\n");
	printf("                 3 | 8K      8K Bytes pagesize\n");
	printf("    ecctype      ECC type\n"); 
	printf("                 0 | none    no ecc\n");
	printf("                 1 | 1bit    used 1bit/512 ecc\n");
	printf("                 2 | 4bit    used 4bit/512 ecc\n");
	printf("                 3 | 8bit    used 8bit/512 ecc\n");
	printf("                 4 | 24bit   used 24bit/1k ecc\n");
	printf("                 5 | 40bit   used 40bit/1k ecc\n");
	printf("    -b blocksize explicitly align blocksize\n");
	printf("    -v           verbosely list files processed\n");
	printf("Example:\n");
	printf("    %s ./rootfs rootfs_4k4bit.yaffs 4k 4bit\n",
		shoftname);
	printf("\n");
}
/*****************************************************************************/
